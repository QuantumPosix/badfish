...
- Black-format emulator.py and main.py
  ([`be5f9b2`](https://github.com/quadsproject/badfish/commit/be5f9b2666f0b473a7ea59feddbc20a77eb8efc5))
...
- Build container images from checked-out code, not cloned master
  ([`c1298cf`](https://github.com/quadsproject/badfish/commit/c1298cf1ac8552fbc436ae9fadecb8b8fc345180))
...
- Declare openssl dep so RPM %check can run the emulator tests
  ([`77ba663`](https://github.com/quadsproject/badfish/commit/77ba6636ebf341996f3aa2efd590016cbf80b3b9))
...
- Drop unused git install and stale Dockerfiles
  ([`ade92f4`](https://github.com/quadsproject/badfish/commit/ade92f4d8c377fe3dbdb1650e5bfa9f12f47248a))
...
- Harden formatted output parsing and check-boot JSON
  ([`b202433`](https://github.com/quadsproject/badfish/commit/b2024339312046c061baa1989eab310b9d0203dc))
...
- Harden multi-attribute BIOS parsing and skip no-op PATCH
  ([`dfe08d3`](https://github.com/quadsproject/badfish/commit/dfe08d38f328ac236702c081a2ce5b637460630d))
...
- Idrac10 virtual media and OS deployment paths
  ([`e2f00c6`](https://github.com/quadsproject/badfish/commit/e2f00c61acbf0b8c1b500ca9a24390a0c7b381b0))
...
- Propagate boot-to failures, join export path, guard init JSON parses
  ([`a0b0a99`](https://github.com/quadsproject/badfish/commit/a0b0a992f87bffc0011f07c2c05b0c4168eebb30))
...
- Reject case-insensitive duplicates and guard a missing BIOS registry
  ([`b0d82b7`](https://github.com/quadsproject/badfish/commit/b0d82b7fcda1bb72f989da9963085225d29ead0d))
...
- **emulator**: Generate self-signed TLS cert at runtime, drop shipped private key
  ([`98be331`](https://github.com/quadsproject/badfish/commit/98be33189618e2f4451853d8aa3ca7e8fde44695))
...
- **emulator**: Serve advertised ServiceRoot resources and harden the user store
  ([`751994f`](https://github.com/quadsproject/badfish/commit/751994fb1985e6eb823c176554f56d7d99aa6a92))
...
- **emulator**: Serve missing network collections, wire SCP export, close RBAC gaps
  ([`2045405`](https://github.com/quadsproject/badfish/commit/2045405b510d6a34e7dc7fd0379840e1948e57e3))
...
- **emulator**: Set member Id so boot-to-mac resolves devices
  ([`dcee876`](https://github.com/quadsproject/badfish/commit/dcee876a1052ae86d2c7eac4be1b4e697d8fe680))
...
- Add rpmlint to CI for RPM hygiene
  ([`2178bc1`](https://github.com/quadsproject/badfish/commit/2178bc19da482d3380b3606449b50c4d9eed3c45))
...
- Bump CI Python to a support version.
  ([`c43f4d0`](https://github.com/quadsproject/badfish/commit/c43f4d0450f9902f726f16abe8d1d8dfbc61c28a))
...
- Rpmlint CI also re-runs on commits, drop stray exec bit
  ([`b66c28c`](https://github.com/quadsproject/badfish/commit/b66c28ced54abf209cacc97b46db0227ade5f4e0))
...
- Gate rpmlint on setup.py and fail loudly on an empty package version
  ([`61f0c0a`](https://github.com/quadsproject/badfish/commit/61f0c0ab04a5b09b5b7a9cd8f8831e285a9fd448))
...
- Only run the dev Quay publish from the canonical repo
  ([`83e6026`](https://github.com/quadsproject/badfish/commit/83e60267f465c0187f7daaba724ed6daefd3e8dd))
...
- Re-run tox and lint on PR synchronize events
  ([`3a8d12a`](https://github.com/quadsproject/badfish/commit/3a8d12ae58f2ef6284ff83cd0407840518c4b1c7))
...
- Skip rpmlint on docs-only PRs and cancel stale runs
  ([`5649dd3`](https://github.com/quadsproject/badfish/commit/5649dd3d0972712ab0d0a53fe1d25f262ec5a42c))
...
- Document --ls-gpu and correct interface-key naming
  ([`e79e293`](https://github.com/quadsproject/badfish/commit/e79e2938db6e2b0ad26befafccef068646f726f7))
...
- Sync README with current badfish feature set
  ([`7054006`](https://github.com/quadsproject/badfish/commit/7054006422f306e397803a78796760a8b278361e))
...
- Add --rack, --uloc, --blade CLI arguments for explicit host location
  ([`30d6b5f`](https://github.com/quadsproject/badfish/commit/30d6b5f088248974f6120e681f1c717063485945))
...
- Add AUR package and CI publishing
  ([`41f0685`](https://github.com/quadsproject/badfish/commit/41f06850f026c3525a825620892497ab77771df7))
...
- Support setting multiple BIOS attributes in one invocation
  ([`1f07abe`](https://github.com/quadsproject/badfish/commit/1f07abead37393e6dafd0d362972021b42529168))
...
- **emulator**: Accountservice user management with role-based RBAC
  ([`4759852`](https://github.com/quadsproject/badfish/commit/4759852ce4bfe60cb959499503e2925afc6f5f0c))
...
- **emulator**: Add built-in Redfish emulator
  ([`e6ab7fc`](https://github.com/quadsproject/badfish/commit/e6ab7fc56fa8346c4a4fed99f6044065d88e5a06))
...
- **emulator**: Jobs run then complete, unknown tasks 404
  ([`daf3549`](https://github.com/quadsproject/badfish/commit/daf3549cbf9852e1c4a3dfad215ae13112ebe175))
...
- Canonicalize BIOS attribute names in a single pass
  ([`dfe95c2`](https://github.com/quadsproject/badfish/commit/dfe95c2fa3f4956ada16ce5305817765cebe4b92))
...
- **emulator**: Data-driven collections, shared body parser, job id helper
  ([`98fa638`](https://github.com/quadsproject/badfish/commit/98fa6383c68863ee9244cc931ae8e3061d88707a))
...
- Cover boot-to-type no-match exit path
  ([`47f0e72`](https://github.com/quadsproject/badfish/commit/47f0e72c603279ad763331fd8ec757e6f2d30d9a))
...
- Cover structured parse guard and defensive diff branches
  ([`801736f`](https://github.com/quadsproject/badfish/commit/801736fd23f0ea2703238845821b406740080582))
...
- **emulator**: Lift patch coverage past the codecov target
  ([`3908c54`](https://github.com/quadsproject/badfish/commit/3908c542a643f5ede5d4ec21979d7bd6ac404134))
